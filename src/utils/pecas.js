const pecas = [
  {
    ...
    htmlContent: `
            ...
            <p style="text-align: justify;"><strong>PRIMEIRA TESTEMUNHA</strong>:&nbsp;<strong>{qualificacao_da_primeira_testemunha}</strong>. Aos costumes, disse _______________. Testemunha compromissada na forma da lei, advertida das penas cominadas ao falso testemunho, prometeu dizer a verdade do que soubesse e lhe fosse perguntado. Inquirida pela Autoridade passou a declarar&nbsp;<strong>{depoimento_da_testemunha}</strong>,&nbsp;___________________. Nada mais disse nem lhe foi perguntado. Lido e achado conforme, determinou a Autoridade que fosse encerrado o presente Termo, o qual assina juntamente com a Testemunha e comigo Escriv&atilde;o que digitei.</p>
            <p>&nbsp;</p>
